...
- Educational and Kaggle use cases  
...
- Clean and structured Pandas DataFrame output
- Easy to extend for visualization or automation
...
├── README.md
├── requirements.txt
├── nifty50_live_data.py
├── nifty50_live_dashboard.ipynb
└── .gitignore
